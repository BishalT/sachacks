...
function switch_active(btn) {
    ...
    btn_num == 1 || btn_num == 3 ? tb_switch_inactive(document.querySelector('.btn-' + (btn_num + 1)), document.querySelector('.tb-' + (btn_num + 1))) : tb_switch_inactive(document.querySelector('.btn-' + (btn_num - 1)), document.querySelector('.tb-' + (btn_num - 1)));
}
...
function timer(date) {
    ...
    if (document.getElementById('days') && document.getElementById('hours') && document.getElementById('min') && document.getElementById('sec')) {
